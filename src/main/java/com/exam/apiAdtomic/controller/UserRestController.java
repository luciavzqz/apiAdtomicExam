...
@RestController
@RequestMapping("/apiAdtomic") //esta sera la raiz de la url, es decir http://127.0.0.1:8080/api/
public class UserRestController {
	...
	public List<User> findAll(
			@RequestParam(value="t", required = false) int t
			){
	...
	public User updateUser(@RequestBody User user) {
		//user/id mandame el id...... users/{userId}
		userService.save(user);
